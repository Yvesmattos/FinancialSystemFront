...
function DespesaFilter({ despesa }) {
            ...
            <Form noValidate style={{fontWeight: 'bold'}}>
                <Form.Row>
                    <Form.Group as={Col} controlId="formNome">
                        ...
                        <Form.Control as="select" name="nomeDespesa" >
                    ...
                    <Form.Group as={Col} controlId="formFavorecido">
                        ...
                        <Form.Control as="select" name="favorecido" >
                            <option defaultValue=""></option>
                ...
                <Form.Row>
                    ...
                    <Form.Group as={Col} controlId="formDataCredito">
                        ...
                        <Form.Control type="date" name="dataVencimento" required value={despesa.dataVencimento} />
                    </Form.Group>
                    <Form.Group as={Col} controlId="formDataPagamento">
                        <Form.Label>Data de pagamento</Form.Label>
                        <Form.Control type="date" name="dataPagamento" value={despesa.dataPagamento} />
                    </Form.Group>
                </Form.Row>
